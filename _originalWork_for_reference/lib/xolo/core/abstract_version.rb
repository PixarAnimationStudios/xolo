...
module Xolo
  ...
  class AbstractVersion
    ...
    # @return [Array<Xolo::KillApp>] The killapps for
    #   the version
    ...
    def initialize(**params)
      ...
      Xolo::Title.validate_title_exists params[:title]
    ...
    def init_from_json(from_json)
      ...
      @killapps = from_json[:killapps].map { |ka| Xolo::Killapp.new ka }
      @killapps ||= []
      @apple_receipt_data = from_json[:apple_receipt_data]
      @apple_receipt_data ||= []
      @changes = from_json[:changes] ? from_json[:changes] : {}
      @standalone = from_json[:standalone]
      @installed_criteria = Xolo::Criteria.new from_json: from_json[:installed_criteria]
      @eligibility_criteria = Xolo::Criteria.new from_json: from_json[:eligibility_criteria]
    end
