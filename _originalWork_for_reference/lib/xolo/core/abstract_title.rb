...
# require 'xolo/core/title/version'
...
module Xolo
  ...
  # server, and as they are used on  client tools (xolo and xoloadmin)
  #
  # In both contexts, Xolo::Title inherits from this class, but have different
  ...
  class AbstractTitle
    ...
    # @return [Xolo::Criteria] The criteria used to determine which managed computers
    ...
    def initialize(**params)
      ...
      @feature_categories = []
      @installed_criteria = Xolo::Criteria.new
    ...
    def init_from_json(from_json)
      ...
      @extension_attributes = from_json[:ext_attrs].map { |ea| Xolo::ExtensionAttribute.new from_json: ea }
