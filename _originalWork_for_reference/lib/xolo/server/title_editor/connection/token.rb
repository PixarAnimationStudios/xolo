  ...
  module TitleEditor
    ...
    class Connection
      ...
      class Token
        ...
        AUTH_RSRC_VERSION = 'v2'

        AUTH_RSRC = 'auth'

        NEW_TOKEN_RSRC = "#{AUTH_RSRC_VERSION}/#{AUTH_RSRC}/tokens"

        REFRESH_RSRC = "#{AUTH_RSRC_VERSION}/#{AUTH_RSRC}/keepalive"

        CURRENT_STATUS_RSRC = "#{AUTH_RSRC_VERSION}/#{AUTH_RSRC}/current"
        ...
        def parse_params(**params)
          ...
          @timeout = params[:timeout] || Xolo::TitleEditor::Connection::DFT_TIMEOUT
