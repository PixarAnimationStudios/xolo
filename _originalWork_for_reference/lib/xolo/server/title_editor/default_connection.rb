...
module Xolo
  ...
  module TitleEditor
    ...
    module DefaultConnection
      ...
      #
      def cnx
        @default_connection ||= Xolo::TitleEditor::Connection.new name: :default
      end
      ...
      def connect(url = nil, **params)
        params[:name] ||= :default
        @default_connection = Xolo::TitleEditor::Connection.new url, **params
      ...
      #
      def cnx=(connection)
        raise 'TitleEditor connections must be instances of Xolo::TitleEditor::Connection' unless connection.is_a? Xolo::TitleEditor::Connection
