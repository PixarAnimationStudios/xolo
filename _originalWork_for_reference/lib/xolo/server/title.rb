...
module Xolo
  ...
  module Server
    ...
    class Title < Xolo::AbstractTitle
      ...
      #
      # A Hash of every Xolo::Server::Title instance in d3, keyed by name
      #
      #   {
      #     'title_name' => Xolo::Server::Title,
      #     'title_name' => Xolo::Server::Title,
      #     'title_name' => Xolo::Server::Title,
      #     ...
      #   }
      ...
      #
      # @param title[String] Unique name of a Xolo::Server::Title
      # @param admin[String]
      # @param msg[String]
      # @return [void]
      #
      ...
      # @return [Hash<Xolo::Version>] all Xolo::Version instances for a given title,
      #   keyed by version string
      #
      def self.versions(name)
        validate_title_exists(name)
        Xolo::Version.data_store[name] || {}
      end
      ...
      #
      # @param vers[Xolo::Server::Version] the version being logged
      ...
      def create(admin)
        ...
        Xolo::Server::Title.add_title_to_data_store self
        Xolo::Server::Title.update_changelog name, admin, "Title Created; #{changes_to_log}"
        @changes.clear
        :created
      end
      ...
      def update(admin)
        ...
        Xolo::Server::Title.update_title_in_data_store self
        Xolo::Server::Title.update_changelog name, admin, "Title Updated; #{changes_to_log}"
        @changes.clear
        :updated
      end
      ...
      def delete
        Xolo::Server::Title.delete_title_from_data_store self
        :deleted
      end

      def validate_title_exists
        Xolo::Server::Title.validate_title_exists name
      end

      def validate_unique_name
        Xolo::Server::Title.validate_unique_name name
      end

      # @return [Pathname] the on-disk representation of this title
      #
      def disk_file
        @disk_file ||= Xolo::Server::Title.data_dir + "#{name}#{Xolo::DOT_YML}"
      end
      ...
      def disk_changelog_file
        @disk_changelog_file ||= Xolo::Server::Title.data_dir + "#{name}#{CHANGELOG}#{Xolo::DOT_YML}"
      end
      ...
      def disk_version_dir
        @disk_version_dir ||= Xolo::Server::Title.data_dir + name
      end
