    ...
    class App < Sinatra::Base
      ...
      def self.prep_to_run(log_level)
        configure do
          ...
          set :logger, D3::Server::Log.startup(log_level)
        ...
        D3::Server::Helpers::Jamf.connect_to_jamf
        D3::Server::Title.load_data_store
        D3::Server::Version.load_data_store
...
require 'd3/server/app/log'

# d3 api
require 'd3/server/app/api'
