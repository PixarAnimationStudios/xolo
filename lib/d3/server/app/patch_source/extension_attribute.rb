...
module D3
  ...
  class ExtensionAttribute
    ...
    DATA_DIR = D3::Server::Config::SUPPORT_DIR + 'extension-attributes'

    # A Hash of every D3::ExtensionAttribute instance in d3, keyed by name
    #
    #   {
    #     'ea_name' => D3::ExtensionAttribute,
    #     'ea_name' => D3::ExtensionAttribute,
    #     'ea_name' => D3::ExtensionAttribute,
    #     ...
    #   }
    ...
    def disk_file
      @disk_file ||= DATA_DIR + "#{name}#{D3::DOT_YML}"
    end
