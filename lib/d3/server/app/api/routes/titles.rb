    ...
    class App < Sinatra::Base
      ...
      namespace API_V1_ROUTE_BASE do
        namespace TITLES_ROUTE_BASE do
          ...
          get '/?' do
            if params[:fields]
              D3::Server::Title.custom_summary_list params[:fields]
            else
              D3::Server::Title.json_summary_list
            end
          end
          ...
          post '/:title', api_admin_only: true do
            ...
            request.body.rewind
            title = D3::Server::Title.new_from_client_json request.body.read
          ...
          get '/:title' do
            ...
            D3::Server::Title.fetch(params[:title]).to_json
          end
          ...
          delete '/:title', api_admin_only: true do
            halt_if_title_not_found! params[:title]
            title = D3::Server::Title.fetch(params[:title])
            title.delete
          ...
          get '/:title/changelog' do
            halt_if_title_not_found! params[:title]
            D3::Server::Title.fetch(params[:title]).changelog_json
          end
