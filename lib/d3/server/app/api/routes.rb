    ...
    class App < Sinatra::Base
      ...
      set(:api_admin_only) do |admin_only|
        condition do
          ...
          if D3::Server::Helpers::Auth::ADMIN_ROLE == session[:role]
...
require 'd3/server/app/api/routes/sessions'
require 'd3/server/app/api/routes/titles'
require 'd3/server/app/api/routes/versions'
require 'd3/server/app/api/routes/categories'
require 'd3/server/app/api/routes/packages'
require 'd3/server/app/api/routes/scripts'
require 'd3/server/app/api/routes/policies'
require 'd3/server/app/api/routes/computer_groups'
require 'd3/server/app/api/routes/test'
