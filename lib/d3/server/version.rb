...
module D3
  ...
  module Server
    ...
    #
    class Version < D3::AbstractVersion
      ...
      #
      # A 2-tiered Hash of every D3::Server::Version instance in d3
      # keyed by title name and then version string.
      #
      #   {
      #     'title_name' => {
      #       'version_string' => D3::Server::Version,
      #       'version_string2' => D3::Server::Version,
      #       ...
      #     }
      #     'title_name2' => {
      #       'version_string3' => D3::Server::Version,
      #       'version_string4' => D3::Server::Version,
      #       ...
      #     }
      #    ...
      #   }
      ...
      def self.load_data_store
        ...
        D3::Server::Title.data_dir.children.each do |item|
        ...
        end # D3::Server::Title.data_dir.children.each do |item|
      ...
      #
      # @param version_to_release[D3::Server::Version]
      #
      def self.release(version_to_release, admin)
        ...
        # Update the title
        D3::Server::Title.fetch(version_to_release.title).released_version = version_to_release.version
      ...
      def create(admin)
        ...
        D3::Server::Title.fetch(title).latest_version = version
        D3::Server::Title.update_changelog title, admin, "Created version '#{@version}'; #{changes_to_log}"
      ...
      def update(admin)
        ...
        D3::Server::Title.update_changelog title, admin, "Updated version '#{@version}'; #{changes_to_log}"
      ...
      def delete
        ...
        D3::Server::Title.update_changelog title, admin, "Deleted version '#{@version}'; #{@changes.join('; ')}"
        :deleted
      end # delete
      ...
      def disk_version_dir
        D3::Server::Title.data_dir + title
      end

      def disk_file
        @disk_file ||= disk_version_dir + "#{version}#{D3::DOT_YML}"
      end
