...
module D3
  ...
  #   attribute defined in the D3::Title containing this criterion.
  #
  # field_name: [String]
  ...
  #
  # D3::Criteria are used in Patch Source data in three ways:
  #
  # - In JSON 'Software Title' Objects (from D3::Title)
  #
  ...
  #      D3::Title#installed_criteria
  #
  # - in JSON 'Patch' Objects (from D3::Version)
  #
  #   - Version eligibility-criteria, aka  'capabilities'
  #     An array of criteria that define which managed computers
  #     may install this specific version. Stored in
  #     D3::Version#eligibility_criteria
  #
  ...
  #     Stored in  D3::Version#installed_criteria
  #
  class Criteria
    ...
    #
    # @return [Array<D3::Criterion>] A frozen dup of the current criteria
    #
    def criteria
      @criteria.dup.freeze
    end
    ...
    # Add a new D3::Criterion to the end of the criteria
    #
    # @param criterion[D3::Criterion] the new Criterion to store
    #
    # @return [void]
    #
    ...
    # Add a new D3::Criterion to the beginning of the criteria
    #
    ...
    # Add a new D3::Criterion to the middle of the criteria
    #
    # @param idx[Integer] the index at which to insert the new one.
    #
    # @param criterion[D3::Criterion] the new Criterion to store at that index
    #
    # @return [void]
    #
    ...
    # Remove a D3::Criterion from the requirement
    #
