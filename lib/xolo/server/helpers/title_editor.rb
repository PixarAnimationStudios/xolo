    ...
    module Helpers
      ...
      module TitleEditor
        ...
        def title_editor_cnx
          ...
          Xolo::Server.logger.debug "Connected to TitleEditor at #{wcnx.base_url} as user '#{Xolo::Server.config.title_editor_api_user}'. KeepAlive: #{wcnx.keep_alive?}, Expires: #{wcnx.token.expires}"
