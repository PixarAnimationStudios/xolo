    ...
    module Helpers
      ...
      module Errors
        ...
        def halt_if_title_not_found!(name)
          return if Xolo::Server::Title.title_exist? name
        ...
        def halt_if_title_already_exists!(name)
          return unless Xolo::Server::Title.title_exist? name
        ...
        def halt_if_version_not_found_in_title!(title, version)
          return if Xolo::Server::Version.version_exist?(title, version)
        ...
        def halt_if_version_already_exists_in_title!(title, version)
          return unless Xolo::Server::Version.version_exist?(title, version)
        ...
        def halt_if_ea_not_found!(name)
          return if Xolo::ExtensionAttribute.data_store.key? name
        ...
        def halt_if_ea_already_exists!(name)
          ind3 = Xolo::ExtensionAttribute.data_store.key? name
