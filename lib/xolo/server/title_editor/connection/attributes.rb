    ...
    module TitleEditor
      ...
      class Connection
        ...
        module Attributes
          ...
          # @return [Xolo::Server::TitleEditor::Connection::Token] the token used for connecting
          attr_reader :token
          ...
          def validate_connection
            raise Xolo::InvalidConnectionError, 'Not connected, use #connect first' unless connected?
          end
