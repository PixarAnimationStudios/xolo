    ...
    class App < Sinatra::Base
      ...
      namespace API_V1_ROUTE_BASE do
        namespace VERSIONS_ROUTE_BASE do
          ...
          get '/?' do
            if params[:fields]
              Xolo::Server::Version.custom_summary_list params[:fields]
            else
              Xolo::Server::Version.json_summary_list
            end
          end
        ...
        namespace TITLES_ROUTE_BASE do
          ...
          # the client Xolo::Server::Title and Xolo::Server::Version classes)
          ...
          get '/:title/version/:version' do
            ...
            Xolo::Server::Version.fetch(params[:title], params[:version]).to_json
          end
