module Xolo
 ...
 class App < Sinatra::Base
    ...
    namespace EAS_ROUTE_BASE do
      ...
      # the summary list
      get '' do
        Xolo::ExtensionAttribute.json_summary_list
      end
      ...
      post '/:ea' do
        ...
        ea_object = Xolo::ExtensionAttribute.new_from_client_json request.body.read
        ea_object.create
      ...
      get '/:ea' do
        ...
        Xolo::ExtensionAttribute.fetch(params[:ea]).to_json
      end
      ...
      delete '/:ea' do
        ...
        ea_object = Xolo::ExtensionAttribute.fetch(params[:ea])
        ea_object.delete
