...
module Xolo
  ...
  module PuppyTime
    ...
    class PendingPuppy
      ...
      # The Xolo::title module provides common attributes and methods related to
      # d3's use of 'titles'
      include Xolo::title
      ...
      #
      def initialize (args = {})
        raise JSS::MissingDataError, "Puppies need a :title" unless args[:title]
        ...
        @id =  Xolo::Package.ids_to_patchs.invert[patch]

        raise JSS::InvalidDataError, "patch #{patch} doesn't exist in d3." unless @id
