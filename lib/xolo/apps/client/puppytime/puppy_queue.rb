...
module Xolo
  module PuppyTime
      ...
      class PuppyQueue
        ...
        QUEUE_FILE = Xolo::SUPPORT_DIR + "d3-pending-puppies.yaml"
        ...
        #
        # @param puppy[Xolo::PendingPupppy] the puppy to add.
        #
        ...
        #
        # @param puppy[String,Xolo::PendingPupppy] the title or Xolo::PendingPupppy
        ...
        def should_run_notification_policy
          ...
          frequency = Xolo::CONFIG.puppy_notification_frequency
  ...
  PUPPY_Q = Xolo::PuppyTime::PuppyQueue.instance
